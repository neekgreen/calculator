namespace WebApi.Models
{
    ...
    {
        decimal ICalculatorEngine.Calculate(string expression)
        {
            return Convert.ToDecimal(new Eval().Execute(expression));
        }


        /// The classes below were taken from http://www.blackbeltcoder.com/Articles/algorithms/a-c-expression-evaluator.
